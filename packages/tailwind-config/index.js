/**
 * Shared Tailwind CSS configuration for Return Signals
 * This provides the base theme with semantic design tokens.
 * Each app extends this with its own content paths.
 *
...
export default {
  theme: {
    extend: {
      ...
      backgroundImage: {
        "radial-glow":
          "radial-gradient(60% 60% at 50% 0%, rgba(15,23,42,0.08) 0%, rgba(71,85,105,0.05) 40%, rgba(255,255,255,0) 70%)",
      },
    },
  },
