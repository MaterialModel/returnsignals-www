...
First, many unhappy customers still want the item they bought; they just believe something is wrong with it. The fit is off, the color looks strange, the fabric feels different from what was expected. If you can find a version that actually works for them, you do more than convert a refund into an exchange and preserve revenue. You help them achieve what they wanted when they placed the order. They gets an item they loves, and they feel cared for by the brand.

Second, some customers are wavering for small, fixable reasons. A waistband feels odd until you show them how to adjust it. A fabric looks different indoors than in sunlight. A minor imperfection turns out to be normal for that material. If someone takes a few minutes to talk them through it, they keep the item. You avoid the return processing cost and retain the original sale.
